        ...
        <div className="popup-contact-content">
          <div className="popup-contact-content_msg">
            <form>
              ...
              <textarea
                className="input-txt input-txt_area"
                placeholder="Message"
              />
    ...
    <>
      <div
        ...
        style={{
          ...
          borderRadius: ".7rem",
          padding: "1rem",
          boxShadow: " .2rem .1rem .2rem .2rem rgba(5, 47, 82, .3)"
        }}
      >
        <div>
          <a style={{ fontSize: "35px", float: "right" }} href="#">
            &times;
          </a>
        </div>
        <div
          style={{
            ...
            padding: "1rem",
            borderRadius: ".7rem",
            backgroundColor: "rgba(5, 47, 82, .4) "
          }}
        >
          Hi there 👋,
        </div>
